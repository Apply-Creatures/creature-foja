...
async function generate(svg, path, { size, bg }) {
  ...
  ctx.scale(
    options.width ? size / options.width : 1,
...
async function main() {
  ...
  await Promise.all([
    ...
    generate(logoSvg, "../public/assets/img/applycreatures.png", { size: 512 }),
    ...
    generate(logoSvg, "../public/assets/img/apple-touch-icon.png", {
      size: 180,
      bg: true,
    }),
